    ...
    <nav className="pt-10 px-10 flex bg-transparent overflow-hidden">
      ...
      p-2 w-10 h-10 justify-left text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100
       focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400
        dark:hover:bg-transparent dark:focus:ring-gray-600"
        ...
        <div
          hidden={!isNavOpen}
          className="w-auto flex flex-wrap items-right  w-full  "
          id="navbar-cta"
        >
          <ul
            className="flex font-medium  md:p-0 mt-4  
     ...
     "
          >
            {navLinks.map((link, idx) => (
              <li
                key={idx}
                className="block py-2 px-3 md:p-2 sm:p-2 text-gray-900 rounded hover:bg-gray-100 
