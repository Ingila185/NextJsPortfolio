...
<svg className="w-10 h-10" viewBox="0 0 1024 1024" >
   ...
   fill="#fff"/>
                    ...
                    {/**Medium */}
                    <a href="https://medium.com/@ingila185" target = "_blank" className="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
                        <svg className='w-10 h-10' viewBox="0 -55 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg"  preserveAspectRatio="xMidYMid">
                            <g>
